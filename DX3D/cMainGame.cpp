...
{
	g_pD3DDevice->Clear(NULL, NULL, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, D3DCOLOR_XRGB(10, 10, 30), 1.0f, 0);
...
{
	D3DXCreateTextureFromFile(g_pD3DDevice, L"../image/¾ÈÀ¯Áø.png", &m_pTexture);
	ST_PT_VERTEX v;
